...
export const FullFavIcon = ({size, strokewidth}) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="rgb(74 71 55)" stroke-width={`${strokewidth}`} style={{width: `${size}`, height: `${size}`}} className={`hover:cursor-pointer hover:scale-110 transition-transform duration-300`}>
