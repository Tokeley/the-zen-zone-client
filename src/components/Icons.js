...
export const FullFavIcon = ({size, strokewidth}) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" stroke-width={`${strokewidth}`} style={{width: `${size}`, height: `${size}`}} className={`hover:cursor-pointer hover:scale-110 transition-transform duration-300`}>
...
export const TickThick = ({size}) => {
  return (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" style={{width: `${size}`, height: `${size}`}}  className={`hover:cursor-pointer hover:scale-110 transition-transform duration-300`}>
          <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
      </svg>
  )
}
...
export const WhatsApp = () => {
  ...
  export const Pinterest = () => {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-pinterest" viewBox="0 0 16 16" className={`hover:cursor-pointer hover:scale-110 transition-transform duration-300`}>
  ...
  export const Twitter = () => {
    return(
        <svg width="40" height="40" viewBox="0 0 44 41" fill="none" xmlns="http://www.w3.org/2000/svg" className={`hover:cursor-pointer hover:scale-110 transition-transform duration-300`}>
            <path d="M34.6526 0.807816H41.3995L26.6594 17.6548L44 40.5798H30.4225L19.7881 26.6759L7.61989 40.5798H0.868864L16.6349 22.56L0 0.807816H13.9222L23.5348 13.5165L34.6526 0.807816ZM32.2846 36.5414H36.0232L11.8908 4.63408H7.87892L32.2846 36.5414Z" fill="currentColor"/>
        </svg>
